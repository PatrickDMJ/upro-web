export default function CallToActionPage() {
  return (
    ...
    >
      <div className="w-full max-w-7xl py-16 sm:py-20 lg:py-24 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8 lg:gap-16">
        {/* Left Content */}
        ...
        <div className="flex flex-col sm:flex-row lg:flex-col xl:flex-row gap-4 lg:gap-6 flex-shrink-0">
          <button className="w-full bg-upro-green text-black font-public font-medium text-lg lg:text-xl px-8 py-3 rounded-lg">
            App Store
          </button>
          <button className="w-full bg-upro-green text-black font-public font-medium text-lg lg:text-xl px-8 py-3 rounded-lg">
            Google Play
